...
public class question3 extends AppCompatActivity
{
    ...
    int correct_answer = 1;  //此題答案為A:印度
    ...
    Button.OnClickListener process = new Button.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            {
                total_correct += 1;
                toast = Toast.makeText(question3.this, "答對!  " +
                        "目前答對題目 / 作答題目  :  " + Integer.toString(total_correct) + " / 3", Toast.LENGTH_SHORT);

            }
            else          //答錯
            {
                toast = Toast.makeText(question3.this, "答錯!  " +
                        "目前答對題目 / 作答題目  :  " + Integer.toString(total_correct) + " / 3", Toast.LENGTH_SHORT);
            }
