...
public class question2 extends AppCompatActivity
{
    ...
    int correct_answer = 2;  //此題答案為B:義大利
    ...
    Button.OnClickListener process = new Button.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            {
                total_correct += 1;
                toast = Toast.makeText(question2.this, "答對!  " +
                        "目前答對題目 / 作答題目  :  " + Integer.toString(total_correct) + " / 2", Toast.LENGTH_SHORT);

            }
            else          //答錯
            {
                toast = Toast.makeText(question2.this, "答錯!  " +
                        "目前答對題目 / 作答題目  :  " + Integer.toString(total_correct) + " / 2", Toast.LENGTH_SHORT);
            }
